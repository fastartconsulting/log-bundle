...
class CheckLogMonitorCommand extends ContainerAwareCommand {
    ...
    protected function configure() {
        $this
            ->setName('check:log-monitor')
            ->setDescription('Check and report the most frequent errors by excluding the 500 levels.')
            ->setHelp('Check and report the most frequent errors by excluding the 500 levels.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $report_file = 'report-log-monitor';
        ...
        try {
            ...
            $output->writeln('');
            $output->writeln('------------------------------');
            $output->writeln('LOGS MONITOR CHECK ERRORS <= 500.');
            $output->writeln('------------------------------');
            $output->writeln('');

            $errors = $this->logMonitorService->getErrors(true);
